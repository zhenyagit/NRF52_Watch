...
static nrfx_spim_t m_spi = NRFX_SPIM_INSTANCE(SPI_INSTANCE);  /**< SPI instance. */

static volatile bool spi_xfer_done;

uint16_t ST7789FB[240*240];
uint8_t  ST7789FB8[65534];
...
void spi_init (void){
	...
	APP_ERROR_CHECK(nrfx_spim_init(&m_spi, &spi_config, NULL, NULL));
}
